...
#' @export
annotateRC <- function(targetTable, xcmsObject, ramclustObj,
                        libs="Lipids", ESImode="POS", RTfile="none",
                        checkIsotope=TRUE, tolerance=25,
                        maxMZdiff=0.01, matchWeight=0.5, ncandidates=5){
...
write.csv(df, 
            file=paste(results$resultsDir, "General_options", ".csv", sep=""))
message('Job done!')
