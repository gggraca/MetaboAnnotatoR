...
First we read the spectrum as data frame into R. In this example we will use the MS/MS spectrum of D-Pantothenic Acid [M+H]+ adduct
from MassBank, accession code: [MSBNK-RIKEN-PR100295](https://massbank.eu/MassBank/RecordDisplay?id=MSBNK-RIKEN-PR100295):
